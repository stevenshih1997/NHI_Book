    ...
    public void onClickMedia (View v)
    {
        ...
        switch (id) {
            case R.id.btn_playback :
                ...
                recordIntent.setClass(F3Activity.this,Story1Playback.class);
                recordIntent.putExtra("fileName", fileName);
                startActivity (recordIntent);
                break;
            case R.id.btn_record :

                recordIntent.setClass(F3Activity.this,F3ActivityRecordStory1.class);
                recordIntent.putExtra("fileName", fileName);
                startActivity (recordIntent);
                break;
            case R.id.btn_playback2 :
                recordIntent.setClass(F3Activity.this,Story2Playback.class);
                recordIntent.putExtra("fileName", fileName);
                startActivity (recordIntent);
                break;
            case R.id.btn_record2 :

                recordIntent.setClass(F3Activity.this,F3ActivityRecordStory2.class);
                recordIntent.putExtra("fileName", fileName);
                startActivity (recordIntent);
                break;
            case R.id.btn_playback3 :
                recordIntent.setClass(F3Activity.this,Story3Playback.class);
                recordIntent.putExtra("fileName", fileName);
                startActivity (recordIntent);
                break;
            case R.id.btn_record3 :

                recordIntent.setClass(F3Activity.this,F3ActivityRecordStory3.class);
                recordIntent.putExtra("fileName", fileName);
