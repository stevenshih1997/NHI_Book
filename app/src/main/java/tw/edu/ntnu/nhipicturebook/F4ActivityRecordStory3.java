...
public class F4ActivityRecordStory3 extends DashboardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f4recordlist);
        productionUI();
    ...
    OnClickListener buttonListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch(v.getId())
            {
                ...
                case 1:
                    fileName = intent.getStringExtra("fileName")+"/Story3";
    ...
    private void creatStoryFile() {
        if(isSDExist()) {
            ...
            String recordPath = SDCardpath.getPath()+ "/Record"+"/Grandpa"+"/Story3";
