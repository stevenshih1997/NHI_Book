...
import tw.edu.ntnu.nhipicturebook.R;
   ...
   super.onStop ();
    ...
    private void creatFile() {
        if(isSDExist()) {
            ...
            String recordPath = SDCardpath.getPath()+ "/Record";
    ...
    private void creatDadFile() {
        if(isSDExist()) {
            File SDCardpath = Environment.getExternalStorageDirectory();
            String recordPath = SDCardpath.getPath()+ "/Record"+"/Dad";
    ...
    private void creatMomFile() {
    if(isSDExist()) {
        File SDCardpath = Environment.getExternalStorageDirectory();
        String recordPath = SDCardpath.getPath()+ "/Record" + "/Mom";
    ...
    private void creatGrandmaFile() {
    if(isSDExist()) {
        File SDCardpath = Environment.getExternalStorageDirectory();
        String recordPath = SDCardpath.getPath()+ "/Record" + "/Grandma";
    ...
    private void creatGrandpaFile() {
        if(isSDExist()) {
            File SDCardpath = Environment.getExternalStorageDirectory();
            String recordPath = SDCardpath.getPath()+ "/Record" + "/Grandpa";
