...
public class F2ActivityRecordStory3 extends DashboardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f2recordlist);
        productionUI();
    ...
    private void creatStoryFile() {
        if(isSDExist()) {
            ...
            String recordPath = SDCardpath.getPath()+ "/Record"+"/Dad"+"/Story3";
