...
public class F3ActivityRecordStory3 extends DashboardActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_f3recordlist);
        productionUI();
    ...
    private void creatStoryFile() {
        if(isSDExist()) {
            ...
            String recordPath = SDCardpath.getPath()+ "/Record"+"/Grandma"+"/Story3";
